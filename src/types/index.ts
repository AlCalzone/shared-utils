...
export type Tail<T extends any[]> =
	...
	[FixedIndizesOf<T>] extends [never] ? T
...
export type Lead<T extends unknown[]> = T extends []
	...
	: T extends [...infer L1, infer _] ? L1
	// tuple with trailing rest element / array
	: T extends [...infer L2] ? L2
	: [];
...
export type LastArgument<T extends (...args: any[]) => any> = Last<Parameters<T>>;
 ...
 * N = 100000 seems to work currently.
 */
export type RangeFrom<N extends number, M extends number> = Exclude<Range<M>, Range<N>>;

/** Tests if N > M */
export type IsGreaterThan<
	N extends number, M extends number,
	RangeN = Range<N>, RangeM = Range<M>,
